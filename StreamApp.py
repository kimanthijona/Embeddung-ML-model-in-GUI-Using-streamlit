...
model = pickle.load(open('C:/Users/PK/Documents/LP4/streamlit app/Ts_model.sav','rb'))
...
path = r"C:\Users\PK\Documents\LP4\streamlit app\MergedData.csv"
merged_data = load_data(path)

image = Image.open(r"C:/Users/PK/Documents/LP4/streamlit app/Predictive.jpg")
